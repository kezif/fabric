...
class DataExtract(HasTraits):
    ...
    data_properties = Button('Data properties')
    ...
    save_group = Group(
        ...
        HGroup('_',
               Item('data_properties', springy=True, show_label=False)
               ),
    )
    ...
    def _data_properties_fired(self):
    ...
    def _open_fired(self):
        ...
        if dialog.open() == OK:
            ...
            traitsui.message.error('file not chosen')
