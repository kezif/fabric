                ...
                with open(dialog.path, 'w', encoding="utf-8") as file:
                    ...
                    if self.methods_list[
                        ...
                        file.write(
                            ...
                            f'\tРасчетное значение {"меньше критического - различия" if int(man["D"])  <= mann_crit else "больше критического - различия не"} подтверждены\n'
                        )  # bruh
                    if self.methods_list[1] in self.methods1:
                        file.write(f'\tРасчетное значение коэфициента Стьюдента: {stu["D"]:.3f}\n' +
                                   ...
                                   f'\tРасчетное значение {"больше критического - различия" if stu["D"] >= t_value else "меньше критического - различия не"} подтверждены\n'
                                   )
                    ...
                    if self.methods_list[0] in self.methods2:
                        file.write(f'\tРасчетное значение критерия Манна — Уитни: {man["R2"]:.3f}\n' +
                                   ...
                                   f'\tРасчетное значение {"меньше критического - различия" if int(man["R2"]) <= mann_crit else "больше критического - различия не"} подтверждены\n'
                                   )
                    if self.methods_list[1] in self.methods2:
                        file.write(f'\tРасчетное значение коэфициента Стьюдента: {stu["R2"]:.3f}\n' +
                                   ...
                                   f'\tРасчетное значение {"больше критического - различия" if stu["R2"] >= t_value else "меньше критического - различия не"} подтверждены\n'
                                   )
                    ...
                    if self.methods_list[0] in self.methods3:
                        file.write(f'\tРасчетное значение критерия Манна — Уитни: {man["A"]:.3f}\n' +
                                   ...
                                   f'\tРасчетное значение {"меньше критического - различия" if int(man["A"]) <= mann_crit else "больше критического - различия не"} подтверждены\n'
                                   )
                    if self.methods_list[1] in self.methods3:
                        file.write(f'\tРасчетное значение коэфициента Стьюдента: {stu["A"]:.3f}\n' +
                                   ...
                                   f'\tРасчетное значение {"больше критического - различия" if stu["A"] >= t_value else "меньше критического - различия не"} подтверждены\n'
                                   )
